 ...
 *     从 v5.3.0 开始支持
 *     
 *     在多个 y 轴为数值轴的时候，可以开启该配置项自动对齐刻度。只对value和log类型的轴有效。
         * @var bool $alignTicks
         */
 ...
 *     }
        ...
        /**
         * 坐标轴轴线相关设置。
         * @var YAxis\AxisLine $axisLine
         */
         public YAxis\AxisLine $axisLine  ;

        /**
         * 坐标轴刻度相关设置。
         * @var YAxis\AxisTick $axisTick
         */
         public YAxis\AxisTick $axisTick  ;
 ...
 *     
 *     2) 在对数轴中使用次刻度线
         * @var YAxis\MinorTick $minorTick
         */
         public YAxis\MinorTick $minorTick  ;

        /**
         * 坐标轴刻度标签的相关设置。
         * @var YAxis\AxisLabel $axisLabel
         */
         public YAxis\AxisLabel $axisLabel  ;

        /**
         * 坐标轴在 grid 区域中的分隔线。
         * @var YAxis\SplitLine $splitLine
         */
         public YAxis\SplitLine $splitLine  ;
 ...
 *     坐标轴在 grid 区域中的次分隔线。次分割线会对齐次刻度线 minorTick
         * @var YAxis\MinorSplitLine $minorSplitLine
         */
         public YAxis\MinorSplitLine $minorSplitLine  ;

        /**
         * 坐标轴在 grid 区域中的分隔区域，默认不显示。
         * @var YAxis\SplitArea $splitArea
         */
         public YAxis\SplitArea $splitArea  ;
 ...
 *     }, 周二, 周三, 周四, 周五, 周六, 周日]
        ...
        /**
         * 坐标轴指示器配置项。
         * @var YAxis\AxisPointer $axisPointer
         */
         public YAxis\AxisPointer $axisPointer  ;
