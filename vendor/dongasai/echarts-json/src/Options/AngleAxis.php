 ...
 * 
 */
class AngleAxis extends AbstractOption {
 ...
 *     }
        ...
        /**
         * 坐标轴轴线相关设置。
         * @var AngleAxis\AxisLine $axisLine
         */
         public AngleAxis\AxisLine $axisLine  ;

        /**
         * 坐标轴刻度相关设置。
         * @var AngleAxis\AxisTick $axisTick
         */
         public AngleAxis\AxisTick $axisTick  ;
 ...
 *     
 *     2) 在对数轴中使用次刻度线
         * @var AngleAxis\MinorTick $minorTick
         */
         public AngleAxis\MinorTick $minorTick  ;

        /**
         * 坐标轴刻度标签的相关设置。
         * @var AngleAxis\AxisLabel $axisLabel
         */
         public AngleAxis\AxisLabel $axisLabel  ;

        /**
         * 坐标轴在 grid 区域中的分隔线。
         * @var AngleAxis\SplitLine $splitLine
         */
         public AngleAxis\SplitLine $splitLine  ;
 ...
 *     坐标轴在 grid 区域中的次分隔线。次分割线会对齐次刻度线 minorTick
         * @var AngleAxis\MinorSplitLine $minorSplitLine
         */
         public AngleAxis\MinorSplitLine $minorSplitLine  ;

        /**
         * 坐标轴在 grid 区域中的分隔区域，默认不显示。
         * @var AngleAxis\SplitArea $splitArea
         */
         public AngleAxis\SplitArea $splitArea  ;
 ...
 *     }, 周二, 周三, 周四, 周五, 周六, 周日]
        ...
        /**
         * 坐标轴指示器配置项。
         * @var AngleAxis\AxisPointer $axisPointer
         */
         public AngleAxis\AxisPointer $axisPointer  ;
