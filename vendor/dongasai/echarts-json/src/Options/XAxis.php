 ...
 * 
 */
class XAxis extends AbstractOption {
 ...
 *     从 v5.3.0 开始支持
 *     
 *     在多个 x 轴为数值轴的时候，可以开启该配置项自动对齐刻度。只对value和log类型的轴有效。
         * @var bool $alignTicks
         */
         public  $alignTicks  = false  ;
 ...
 *     end
        ...
        /**
         * 坐标轴名称的文字样式。
         * @var XAxis\NameTextStyle $nameTextStyle
         */
         public XAxis\NameTextStyle $nameTextStyle  ;
 ...
 *     }
        ...
        /**
         * 坐标轴轴线相关设置。
         * @var XAxis\AxisLine $axisLine
         */
         public XAxis\AxisLine $axisLine  ;

        /**
         * 坐标轴刻度相关设置。
         * @var XAxis\AxisTick $axisTick
         */
         public XAxis\AxisTick $axisTick  ;
 ...
 *     
 *     2) 在对数轴中使用次刻度线
         * @var XAxis\MinorTick $minorTick
         */
         public XAxis\MinorTick $minorTick  ;

        /**
         * 坐标轴刻度标签的相关设置。
         * @var XAxis\AxisLabel $axisLabel
         */
         public XAxis\AxisLabel $axisLabel  ;

        /**
         * 坐标轴在 grid 区域中的分隔线。
         * @var XAxis\SplitLine $splitLine
         */
         public XAxis\SplitLine $splitLine  ;
 ...
 *     坐标轴在 grid 区域中的次分隔线。次分割线会对齐次刻度线 minorTick
         * @var XAxis\MinorSplitLine $minorSplitLine
         */
         public XAxis\MinorSplitLine $minorSplitLine  ;

        /**
         * 坐标轴在 grid 区域中的分隔区域，默认不显示。
         * @var XAxis\SplitArea $splitArea
         */
         public XAxis\SplitArea $splitArea  ;
 ...
 *     }, 周二, 周三, 周四, 周五, 周六, 周日]
        ...
        /**
         * 坐标轴指示器配置项。
         * @var XAxis\AxisPointer $axisPointer
         */
         public XAxis\AxisPointer $axisPointer  ;
