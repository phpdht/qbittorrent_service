 ...
 * 
 */
class SingleAxis extends AbstractOption {
 ...
 *     end
        ...
        /**
         * 坐标轴名称的文字样式。
         * @var SingleAxis\NameTextStyle $nameTextStyle
         */
         public SingleAxis\NameTextStyle $nameTextStyle  ;
 ...
 *     }
        ...
        /**
         * 坐标轴轴线相关设置。
         * @var SingleAxis\AxisLine $axisLine
         */
         public SingleAxis\AxisLine $axisLine  ;

        /**
         * 坐标轴刻度相关设置。
         * @var SingleAxis\AxisTick $axisTick
         */
         public SingleAxis\AxisTick $axisTick  ;
 ...
 *     
 *     2) 在对数轴中使用次刻度线
         * @var SingleAxis\MinorTick $minorTick
         */
         public SingleAxis\MinorTick $minorTick  ;

        /**
         * 坐标轴刻度标签的相关设置。
         * @var SingleAxis\AxisLabel $axisLabel
         */
         public SingleAxis\AxisLabel $axisLabel  ;

        /**
         * 坐标轴在 grid 区域中的分隔线。
         * @var SingleAxis\SplitLine $splitLine
         */
         public SingleAxis\SplitLine $splitLine  ;
 ...
 *     坐标轴在 grid 区域中的次分隔线。次分割线会对齐次刻度线 minorTick
         * @var SingleAxis\MinorSplitLine $minorSplitLine
         */
         public SingleAxis\MinorSplitLine $minorSplitLine  ;

        /**
         * 坐标轴在 grid 区域中的分隔区域，默认不显示。
         * @var SingleAxis\SplitArea $splitArea
         */
         public SingleAxis\SplitArea $splitArea  ;
 ...
 *     }, 周二, 周三, 周四, 周五, 周六, 周日]
        ...
        /**
         * 坐标轴指示器配置项。
         * @var SingleAxis\AxisPointer $axisPointer
         */
         public SingleAxis\AxisPointer $axisPointer  ;
 ...
 *     可以设置在系列的每个数据项中，即 series.data.tooltip
         * @var SingleAxis\Tooltip $tooltip
         */
         public SingleAxis\Tooltip $tooltip  ;
