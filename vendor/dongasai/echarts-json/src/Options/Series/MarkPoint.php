 ...
 * 
 */
class MarkPoint extends AbstractOption {
 ...
 *     图形是否不响应和触发鼠标事件，默认为 false，即响应和触发鼠标事件。
        ...
        /**
         * 标注的文本。
         * @var MarkPoint\Label $label
         */
         public MarkPoint\Label $label  ;

        /**
         * 标注的样式。
         * @var MarkPoint\ItemStyle $itemStyle
         */
         public MarkPoint\ItemStyle $itemStyle  ;

        /**
         * 标注的高亮样式。
         * @var MarkPoint\Emphasis $emphasis
         */
         public MarkPoint\Emphasis $emphasis  ;
 ...
 *     
 *     标注的淡出样式。淡出的规则跟随所在系列。
         * @var MarkPoint\Blur $blur
         */
         public MarkPoint\Blur $blur  ;
