...
namespace EchartsJson\Options\Series\ItemStyle;
 ...
 *     可以结合以下的例子理解本接口：
         ...
         */
         public  $maxTileWidth  = 512 ;

        /**
         * 生成的图案在未重复之前的高度上限。通常不需要设置该值，当你发现图案在重复的时候出现不连续的接缝时，可以尝试提高该值。
         * @var int $maxTileHeight
         */
         public  $maxTileHeight  = 512 ;
