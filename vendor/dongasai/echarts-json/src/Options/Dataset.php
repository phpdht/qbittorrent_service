 ...
 * 
 */
class Dataset extends AbstractOption {
 ...
 *     参见 数据变换教程
         * @var int $fromDatasetIndex
         */
         public  $fromDatasetIndex  ;

        /**
         * 指定 dataset.transform 以哪个 dataset 作为输入。
 *     参见 数据变换教程
         * @var string $fromDatasetId
         */
         public  $fromDatasetId  ;
 ...
 *     参见 数据变换教程
         * @var int $fromTransformResult
         */
         public  $fromTransformResult  ;
