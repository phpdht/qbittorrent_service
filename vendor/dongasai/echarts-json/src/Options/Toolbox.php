 ...
 * 
 */
class Toolbox extends AbstractOption {
 ...
 *         }
 *     }
         * @var Toolbox\Feature $feature
         */
         public Toolbox\Feature $feature  ;

        /**
         * 公用的 icon 样式设置。由于 icon 的文本信息只在 icon hover 时候才显示，所以文字相关的配置项请在 emphasis 下设置。
         * @var Toolbox\IconStyle $iconStyle
         */
         public Toolbox\IconStyle $iconStyle  ;

        /**
         * 
         * @var Toolbox\Emphasis $emphasis
         */
         public Toolbox\Emphasis $emphasis  ;
