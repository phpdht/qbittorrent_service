...
namespace EchartsJson\Options\Parallel;
 ...
 * 
 */
class ParallelAxisDefault extends AbstractOption {
 ...
 *     end
        ...
        /**
         * 坐标轴名称的文字样式。
         * @var ParallelAxisDefault\NameTextStyle $nameTextStyle
         */
         public ParallelAxisDefault\NameTextStyle $nameTextStyle  ;
 ...
 *     }
        ...
        /**
         * 坐标轴轴线相关设置。
         * @var ParallelAxisDefault\AxisLine $axisLine
         */
         public ParallelAxisDefault\AxisLine $axisLine  ;

        /**
         * 坐标轴刻度相关设置。
         * @var ParallelAxisDefault\AxisTick $axisTick
         */
         public ParallelAxisDefault\AxisTick $axisTick  ;
 ...
 *     
 *     2) 在对数轴中使用次刻度线
         * @var ParallelAxisDefault\MinorTick $minorTick
         */
         public ParallelAxisDefault\MinorTick $minorTick  ;

        /**
         * 坐标轴刻度标签的相关设置。
         * @var ParallelAxisDefault\AxisLabel $axisLabel
         */
         public ParallelAxisDefault\AxisLabel $axisLabel  ;
