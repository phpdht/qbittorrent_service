 ...
 * 
 */
class ItemStyle extends AbstractOption {
 ...
 *     更多详情可以参考 MDN lineDashOffset。
         ...
         */
         public  $borderDashOffset  = "inherit"  ;
 ...
 *     更多详情可以参考 MDN miterLimit。
         ...
         */
         public  $borderMiterLimit  = "inherit"  ;
 ...
 *     图形透明度。支持从 0 到 1 的数字，为 0 时不绘制该图形。
         * @var int $opacity
         */
         public  $opacity  = "inherit"  ;

        /**
         * 图形的贴花图案，在 aria.enabled 与 aria.decal.show 都是 true 的情况下才生效。
 *     如果为 none 表示不使用贴花图案。
         * @var ItemStyle\Decal $decal
         */
         public ItemStyle\Decal $decal  = "inherit"  ;
