 ...
 * 
 */
class VisualMap extends AbstractOption {
 ...
 *     配置参考 visualMap-continuous.inRange
         ...
         * @var VisualMap\Controller $controller
         */
         public VisualMap\Controller $controller  ;
 ...
 *     如果要使用，则须注意，color属性中的顺序是由数值 大 到 小，但是 visualMap-continuous.inRange 或 visualMap-continuous.outOfRange 中 color 的顺序，总是由数值 小 到 大。二者不一致。
         * @var array $color
         */
         public  $color  = "[\'#bf444c\', \'#d88273\', \'#f6efa6\']"  ;

        /**
         * 
         * @var VisualMap\TextStyle $textStyle
         */
         public VisualMap\TextStyle $textStyle  ;
 ...
 *     
 *     手柄的样式配置。
         * @var VisualMap\HandleStyle $handleStyle
         */
         public VisualMap\HandleStyle $handleStyle  ;

        /**
         * 指示器的形状，默认为圆形。指示器在鼠标移到组件上，或者在移到系列图形上联动高亮的时候出现。
 *     
 *     从 v5.0.0 开始支持
         * @var string $indicatorIcon
         */
         public  $indicatorIcon  = "circle"  ;
 ...
 *     指示器的大小。可以是相对于组件尺寸的百分比大小。
         * @var int|string $indicatorSize
         */
         public  $indicatorSize  = "50%"  ;

        /**
         * 指示器样式。
         * @var VisualMap\IndicatorStyle $indicatorStyle
         */
         public VisualMap\IndicatorStyle $indicatorStyle  ;
