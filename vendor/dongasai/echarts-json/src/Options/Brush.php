 ...
 *     number: 某个 series index
         * @var array|int|string $seriesIndex
         */
 ...
 *         }
 *     };
         * @var array|int|string $xAxisIndex
         */
         public  $xAxisIndex  ;
 ...
 *         }
 *     };
         * @var array|int|string $yAxisIndex
         */
         public  $yAxisIndex  ;
 ...
 *     single：单选。
 *     multiple：多选。
         * @var string $brushMode
         */
         public  $brushMode  = "single"  ;

        /**
         * 已经选好的选框是否可以被调整形状或平移。
         * @var bool $transformable
         */
 ...
 *     debounce：表示只有停止动作了（即一段时间没有操作了），才会触发事件。时间阈值由 brush.throttleDelay 指定。
 *     fixRate：表示按照一定的频率触发事件，时间间隔由 brush.throttleDelay 指定。
         * @var int $throttleDelay
         */
         public  $throttleDelay  = 0 ;

        /**
         * 在 brush.brushMode 为 single 的情况下，是否支持『单击清除所有选框』。
         * @var bool $removeOnClick
         */
         public  $removeOnClick  = true  ;
