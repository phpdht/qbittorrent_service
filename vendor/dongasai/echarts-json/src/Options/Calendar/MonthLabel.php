 ...
 * 
 */
class MonthLabel extends AbstractOption {
 ...
 *     end
         ...
         * 
 *     
 *     月份显示的效果，默认为en。从 v5.2.2 起，默认为初始化图表 时指定的语言 locale，如未指定则根据浏览器语言自动侦测。
 ...
 *     
 *     详情参见教程：富文本标签
         * @var MonthLabel\Rich $rich
         */
         public MonthLabel\Rich $rich  ;
