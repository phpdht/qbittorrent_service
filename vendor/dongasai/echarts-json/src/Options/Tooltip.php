 ...
 * 
 */
class Tooltip extends AbstractOption {
 ...
 *     对于数值轴、时间轴，如果开启了 snap，则 axisPointer 会自动吸附到最近的点上。
         * @var Tooltip\AxisPointer $axisPointer
         */
         public Tooltip\AxisPointer $axisPointer  ;
 ...
 *       鼠标所在图形底侧，只在 trigger 为item的时候有效。
         * @var string|array|callable $position
         */
         public  $position  ;
 ...
 *     ]
        ...
        /**
         * 提示框浮层的文本样式。
         * @var Tooltip\TextStyle $textStyle
         */
         public Tooltip\TextStyle $textStyle  ;
